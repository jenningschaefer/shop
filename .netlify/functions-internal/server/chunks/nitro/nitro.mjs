...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "07fa8ab6-7e4f-4c64-a2ef-31cef016b933",
...
const _3a17vZYTxwlEJOXW0XjBBVgfAh8UpxUvRbawx7RFzZQ = defineNitroPlugin((nitroApp) => {
  ...
  de: [
    {
      ...
      load: () => import('../_/de.mjs' /* webpackChunkName: "locale_de_46json_e3d0f41d" */),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import('../_/en.mjs' /* webpackChunkName: "locale_en_46json_c9de6045" */),
      cache: true
    }
  ]
};
...
const _yp7Asj64hp7TmbR5u5lGH18aSlP4sIkeKo7sAkBG_M4 = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/ue3yyBqY") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _3a17vZYTxwlEJOXW0XjBBVgfAh8UpxUvRbawx7RFzZQ,
_yp7Asj64hp7TmbR5u5lGH18aSlP4sIkeKo7sAkBG_M4
];

const _SxA8c9 = defineEventHandler(() => {});

const _aFiWGi = eventHandler(async (event) => {
  await clearUserSession(event);
  return { loggedOut: true };
});

const _9gq6iK = eventHandler(async (event) => {
...
const _Gg7_cz = _messagesHandlerCached;

const _lazy_lzukNB = () => import('../routes/api/auth/_registered.mjs');
const _lazy_WUTttJ = () => import('../routes/api/auth/guest.post.mjs');
const _lazy_PSwv5L = () => import('../routes/api/auth/login.post.mjs');
const _lazy_DE44PV = () => import('../routes/api/auth/register.post.mjs');
const _lazy_8KySJp = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/auth/_registered', handler: _lazy_lzukNB, lazy: true, middleware: false, method: undefined },
  { route: '/api/auth/guest', handler: _lazy_WUTttJ, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/login', handler: _lazy_PSwv5L, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/register', handler: _lazy_DE44PV, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_8KySJp, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_auth/session', handler: _aFiWGi, lazy: false, middleware: false, method: "delete" },
  { route: '/api/_auth/session', handler: _9gq6iK, lazy: false, middleware: false, method: "get" },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _Gg7_cz, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_8KySJp, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, joinURL as A, parseQuery as B, appendResponseHeader as C, withQuery as D, sanitizeStatusCode as E, getContext as F, withTrailingSlash as G, withoutTrailingSlash as H, baseURL as I, createHooks$1 as J, executeAsync as K, toRouteMatcher as L, createRouter$1 as M, defu as N, getRequestURL as O, getRequestHeader as P, klona as Q, isEqual as R, createDefu as S, parsePath as T, deleteCookie as U, withLeadingSlash as V, parseURL as W, encodeQueryItem as X, handler as Y, setCookie as a, appRootTag as b, createError$1 as c, defineEventHandler as d, appRootAttrs as e, buildAssetsURL as f, getCookie as g, appSpaLoaderTag as h, appSpaLoaderAttrs as i, getResponseStatusText as j, getResponseStatus as k, appId as l, defineRenderHandler as m, appTeleportTag as n, appTeleportAttrs as o, publicAssetsURL as p, getQuery as q, readBody as r, setUserSession as s, appHead as t, useRuntimeConfig as u, destr as v, getRouteRules as w, useNitroApp as x, hasProtocol as y, isScriptProtocol as z };
