...
import { defineComponent, computed, ref, h, unref, withCtx, createVNode, toDisplayString, isRef, createTextVNode, useSSRContext } from 'vue';
import { _ as _sfc_main$1, a as __nuxt_component_1 } from './accordion-item-C2fGNNOD.mjs';
import { _ as _sfc_main$2 } from './sidenav-BVv2_2at.mjs';
import { _ as _sfc_main$3 } from './Cart-GSrLnc31.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UISidenav = _sfc_main$2;
      const _component_OrderCart = _sfc_main$3;
      _push(`<!--[-->`);
      if (unref(product) != null) {
        _push(`<div class="product"><div class="product_details-mobile"><div>by ${ssrInterpolate(unref(product).designer)}</div><div>${ssrInterpolate(unref(product).price_us)}$</div></div><div class="product_description"><h1 class="product_description-title">${ssrInterpolate(unref(product).name)}</h1>`);
        ...
        _push(`</div><div class="product_description-add"><div class="product_description-add-desc">by ${ssrInterpolate(unref(product).designer)}</div><div class="product_description-add-desc">${ssrInterpolate(unref(product).price_us)}$</div><button class="vesta-btn" type="button">Add to Cart</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=_name_-_id_-Y4dqaY0W.mjs.map
