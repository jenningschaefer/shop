...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.CJZ0s4Zd.mjs').then(interopDefault),
  ...
  "components/UI/accordion-item.vue": () => import('./accordion-item-styles.CbVBwg6M.mjs').then(interopDefault),
  "components/UI/accordion-item.vue?vue&type=style&index=0&scoped=89a8463c&lang.scss": () => import('./accordion-item-styles.v7kT190F.mjs').then(interopDefault)
};
