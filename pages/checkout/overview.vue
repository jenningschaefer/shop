...
// Static, locale-specific Terms & Conditions PDF (generated by `npm run generate:terms`).
  ...
  <div class="overview">
    ...
    <div class="overview_container">
      ...
      <div class="overview_legal">
        <a class="overview_legal-tt" :href="termsPdf" target="_blank" rel="noopener" download>
